class CompetitorsController < ApplicationController
  ...
  def show
    @competitor_checkins = @competitor.checkins
    @competitor_checkins_qtty = @competitor_checkins.count
    @competitor_points = @competitor.activities.sum(:points)
  end
  ...
  private
    ...
    def competitor_params
      params.require(:competitor).permit(:name, :email, :team_id)
    end
end
