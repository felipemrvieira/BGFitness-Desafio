...
class CompetitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competitor" do
    assert_difference('Competitor.count') do
      post competitors_url, params: { competitor: { email: @competitor.email, name: @competitor.name, team_id: @competitor.team_id } }
    end
  ...
  test "should update competitor" do
    patch competitor_url(@competitor), params: { competitor: { email: @competitor.email, name: @competitor.name, team_id: @competitor.team_id } }
