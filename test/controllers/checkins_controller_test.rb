...
class CheckinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post checkins_url, params: { checkin: { activity_id: @checkin.activity_id, competitor_id: @checkin.competitor_id, date: @checkin.date } }
    end
  ...
  test "should update checkin" do
    patch checkin_url(@checkin), params: { checkin: { activity_id: @checkin.activity_id, competitor_id: @checkin.competitor_id, date: @checkin.date } }
